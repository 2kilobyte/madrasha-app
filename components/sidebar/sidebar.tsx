      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          <button
            ...
            className="flex items-center p-2 text-gray-900 rounded-lg dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 group dark:hover:text-red-300"
          >
            <svg
              className="flex-shrink-0 w-5 h-5 text-red-400 transition duration-75 dark:text-red-400 group-hover:text-gray-900 dark:group-hover:text-red-300"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 18 16"
