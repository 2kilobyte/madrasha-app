...
export default function Dashboard() {
    ...
    return (
        <>
            {
                dashboardData ?
                <div className="w-full pl-64 bg-[#101316] min-h-screen">
                    ...
                    <h5 className='inline text-2xl/none font-semibold'>BDT {dashboardData.currentMonthTotalFee}</h5>
                    ...
                    <h5 className='inline text-2xl/none font-semibold'>BDT {dashboardData.currentMonthPaidFee}</h5>
                    ...
                    <h5 className='inline text-2xl/none font-semibold'>BDT {dashboardData.currentMonthUnpaidFee}</h5>
                    <p className='text-sm font-medium dark:text-[#dcebfab3]'>Students have to pay this amount</p>
                    </div>

                    <div className='relative flex flex-col rounded-md bg-[#191e23] p-6'>
                    <div className='flex flex-row items-center justify-between mb-4 text-[#dcebfab3]'>
                        <p className='text-sm font-medium'>Unpaid students</p>
                        <svg
                        className="w-6 h-6 text-gray-800 dark:text-[#dcebfab3]"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h5 className='inline text-2xl/none font-semibold'>{dashboardData.totalStudents}</h5>
             ...
             {
                dashboardData.currentMonthUnpaidStudents.length > 0  &&
                    ...
                    {
                        dashboardData.currentMonthUnpaidStudents.map(student => (
                ...
                : 
                <div className='w-full pl-64 h-screen flex items-center justify-center bg-[#101316]'>
                    <div role="status">
                        <svg
                            aria-hidden="true"
